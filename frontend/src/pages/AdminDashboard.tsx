    ...
    <main className='relative w-full min-h-screen text-white'>
        ...
        <div className='w-full fixed top-0 h-20 bg-black flex justify-between items-center px-10 z-10'>
          ...
          <div className='flex gap-4 items-center justify-center text-black'>
            ...
            <Link to='/view-libriarians' className='bg-white hover:bg-gray-300 active:bg-gray-400 transition-colors px-4 py-2 rounded-lg'>View Librarians</Link>
            <Link to='/view-members' className='bg-white hover:bg-gray-300 active:bg-gray-400 transition-colors px-4 py-2 rounded-lg'>View Members</Link>
